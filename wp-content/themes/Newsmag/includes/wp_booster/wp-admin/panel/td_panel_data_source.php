        ...
        if (current_user_can('switch_themes')) {
            ...
            switch ($td_ajax_view) {
                ...
                case 'td_theme_fonts':
                    ...
                    //section can start from 0, any verification, excerpt if is a number, is useless
                    if ($td_section_id >= 0 ) {

                        include_once('ajax_views/td_theme_fonts.php');

                        $object_custom_typography_ajax = new td_panel_custom_typography_ajax();
                        $buffy = $object_custom_typography_ajax->td_custom_typology_generate_font_controls(array($td_start_section, $td_end_section)) . '<div class="td-clear"></div>';
                    }
                    break;
            }
