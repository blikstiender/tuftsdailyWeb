...
function td_on_theme_activate($oldname, $oldtheme=false) {
    ...
    (
        ...
        'homepage_5230' => Array (
	        ...
	        'template' => '[vc_row][vc_column width="1/1"][td_block_trending_now limit="3"][td_block_big_grid][/vc_column][/vc_row][vc_row][vc_column width="2/3"][td_block_2 limit="6" custom_title="DON\'T MISS" header_color="#4db2ec" td_filter_default_txt="All" ajax_pagination="next_prev" border_top="no_border_top"][td_block_1 limit="5" custom_title="GADGET WORLD" header_color="#0b8d5d" td_filter_default_txt="All"] [td_ad_box spot_id="custom_ad_1"][td_block_2 limit="6" custom_title="TRAVEL GUIDES" header_color="#f24b4b" td_filter_default_txt="All" ajax_pagination="next_prev"][/vc_column][vc_column width="1/3"][td_social_counter custom_title="STAY CONNECTED" facebook="themeforest" twitter="envato" youtube="Envato" open_in_new_window="y" border_top="no_border_top"][td_ad_box spot_id="sidebar"][td_block_2 limit="3" custom_title="LATEST REVIEWS" td_filter_default_txt="All"][td_slide limit="3" custom_title="POPULAR VIDEO" td_filter_default_txt="All"][td_block_9 limit="3" custom_title="CHICAGO SHOW" td_filter_default_txt="All"][/vc_column][/vc_row][vc_row el_class="td-ss-row"][vc_column width="2/3"][td_block_2 limit="6" custom_title="FASHION AND TRENDS" header_color="#ff3e9f"  td_filter_default_txt="All"][/vc_column][vc_column width="1/3"][td_block_7 limit="1" custom_title="EDITOR PICKS" td_filter_default_txt="All"][td_ad_box spot_id="sidebar"][/vc_column][/vc_row][vc_row css=".td-top-border{border-top-width: 1px !important;}"][vc_column width="1/1"][td_ad_box spot_id="custom_ad_2"][/vc_column][/vc_row]'
        ),
        ...
        'homepage_5250' => Array (
	        ...
	        'template' => '[vc_row][vc_column width="1/1"][td_block_trending_now limit="3"][/vc_column][/vc_row][vc_row css=".td-top-border{border-top-width: 1px !important;}"][vc_column width="2/3"][td_slide limit="3" td_filter_default_txt="All"][td_block_2 limit="6" custom_title="DON\'T MISS" td_filter_default_txt="All" ajax_pagination="next_prev" border_top="no_border_top"][td_block_1 limit="5" custom_title="GADGETS WORLD" td_filter_default_txt="All" border_top="no_border_top"][td_ad_box spot_id="custom_ad_1"][td_block_15 limit="8" custom_title="LIFESTYLE" td_filter_default_txt="All"][/vc_column][vc_column width="1/3"][td_social_counter facebook="themeforest" twitter="envato" youtube="Envato" custom_title="STAY CONNECTED" border_top="no_border_top"][td_block_9 limit="5" custom_title="LIFESTYLE" td_filter_default_txt="All" ajax_pagination="next_prev" border_top="no_border_top"][td_ad_box spot_id="sidebar"][vc_wp_posts show_date="1" title="RECENT POSTS" number="5"][td_block_2 limit="3" custom_title="LATEST REVIEWS" td_filter_default_txt="All"][/vc_column][/vc_row]'
        ),

        'homepage_5260' => Array (
	        'name' => 'Homepage - fashion',
	        'template' => '[vc_row][vc_column width="1/1"][td_homepage_full_1][td_block_2 limit="3" custom_title="MOST POPULAR" border_top="no_border_top"  td_filter_default_txt="All" ajax_pagination="next_prev"][/vc_column][/vc_row]'
        ),
        ...
        'contact_533' => Array (
            'name' => 'Contact',
            'template' => '[vc_row][vc_column width="2/3"][vc_column_text]Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse non nunc ac quam congue fermentum et vel massa. Proin imperdiet pulvinar rhoncus. Integer in elit accumsan, ullamcorper ante non, commodo velit. Nunc luctus scelerisque dui, vitae luctus est auctor eu.[/vc_column_text][vc_row_inner][vc_column_inner width="1/2"][td_text_with_title custom_title="Contact Details"]Newsmag Comunication Service
425 Santa Teresa St. Stanford

(650) 723-2558 (main number)
(650) 725-0247 (fax)

Email: contact@newsmag.com[/td_text_with_title][/vc_column_inner][vc_column_inner width="1/2" css=".td-no-left-border{border-left-width: 0px !important;}"][td_text_with_title custom_title="About us"]Newsmag is your news, entertainment, music fashion website. We provide you with the latest breaking news and videos straight from the entertainment industry.[/td_text_with_title][/vc_column_inner][/vc_row_inner][/vc_column][vc_column width="1/3"][vc_widget_sidebar sidebar_id="td-default"][/vc_column][/vc_row]'
        ),
