            ...
            */
            ...
            if (is_array($count_7_day_array)) {
                ...
                if (isset($count_7_day_array[$get_current_day])) {
                    ...
                    $post_view_7days_last_day = get_post_meta($postID, self::$post_view_7days_last_day, true);



                    if ($post_view_7days_last_day == $get_current_day) {
                    ...
                    update_post_meta($postID, self::$post_view_7days_last_day, $get_current_day);
