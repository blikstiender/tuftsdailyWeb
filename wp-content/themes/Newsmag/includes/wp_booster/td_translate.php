...
$td_translation_map = array(
    ...
    'RELATED ARTICLES' => __('RELATED ARTICLES', TD_THEME_NAME),
    ...
    "Sorry, but the page you are looking for doesn't exist." => __("Sorry, but the page you are looking for doesn't exist.", TD_THEME_NAME),
    ...
    //used in Popular Category widget (td_popular_categories.php file)
