...
$data['custom_class'] = ''; // default is ''
$data['content']    = <<<CONTENT
[vc_row][vc_column width="1/1"][td_homepage_full_1][td_block_2 limit="3" custom_title="MOST POPULAR" border_top="no_border_top"  td_filter_default_txt="All" ajax_pagination="next_prev"][/vc_column][/vc_row]
CONTENT;
