    ...
    function render_list_item($item_array, $current_item_id, $current_item_number, $total_items_number) {
        ...
        $first_img_info = wp_get_attachment_image_src($item_array['first_img_id'], 'td_300x350');
            ...
            if (!empty($first_img_info[0])) {
                $buffy_image = '
                           <figure class="td-sml3-display-image td-slide-smart-list-figure">
                                <a class="td-sml3-link-to-image" href="' . $first_img_all_info['src'] . '" id="td-sml3-slide_' . $this->nr_slide_on_smart_list . '" data-caption="' . esc_attr($first_img_all_info['caption'], ENT_QUOTES) . '" >
            ...
            if(!empty($item_array['description'])) {
                ...
                $temp_description = '<div class="td-number-and-title"><h2><a href="" name="' . $current_item_id . '"> <span class="td-sml3-current-item-nr">' . $current_item_number. '</span><span class="td-sml3-current-item-title ' . $class_verticle_align_top . '"><span class="td-mobile-nr">' . $current_item_number. '</span> ' . $smart_list_3_title . '</span></a></h2></div>' . $temp_description;
