...
class td_smart_list_1 extends td_smart_list {
    ...
    function render_list_item($item_array, $current_item_id, $current_item_number, $total_items_number) {
        ...
        $buffy .= '<div class="td-item" id="' . $this->smart_list_tip_1_unique_id . '_item_' . $current_item_id . '">';
            $buffy .= '<span class="td-number-and-title"><h2><a href="" name="' . $current_item_id . '"> <span class="td-sml1-current-item-nr">' . $current_item_number. '</span><span class="td-sml1-current-item-title">' . $smart_list_1_title . '</span></a></h2></span>';
            ...
            if (!empty($first_img_info[0])) {
                $buffy .= '
                        <figure class="td-slide-smart-list-figure td-slide-smart-list-1">
                            <a class="td-sml1-link-to-image" href="' . $first_img_all_info['src'] . '" id="td-sml1-slide_' . $this->nr_slide_on_smart_list . '" data-caption="' . esc_attr($first_img_all_info['caption'], ENT_QUOTES) . '">
