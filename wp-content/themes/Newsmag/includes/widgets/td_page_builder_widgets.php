...
class td_popular_categories_widget extends td_block_widget {
    var $td_block_id = 'td_popular_categories'; // change only the block id, the rest is autogenerated
}

add_action('widgets_init', create_function('', 'return register_widget("td_popular_categories_widget");'));
...
class td_text_with_title_widget extends td_block_widget {
    var $td_block_id = 'td_text_with_title'; // change only the block id, the rest is autogenerated
}

add_action('widgets_init', create_function('', 'return register_widget("td_text_with_title_widget");'));
