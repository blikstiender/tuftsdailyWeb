...
<?php if ( have_comments() ) : ?>
      <div class="headline"><h2><?php comments_number(__('No Responses', THB_THEME_NAME), __('One Response', THB_THEME_NAME), __('% Responses', THB_THEME_NAME) ); ?></h2> <a href="#respond"><?php _e("Leave a Reply", THB_THEME_NAME); ?></a></div>
