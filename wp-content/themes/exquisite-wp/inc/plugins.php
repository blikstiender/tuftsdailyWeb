...
function thb_register_required_plugins() {
	$plugins = array(
		array(
			'name'     				=> '() Exquisite - Shortcodes & Widgets', // The plugin name
			'slug'     				=> 'exquisite-wp-plugin', // The plugin slug (typically the folder name)
			'source'   				=> get_bloginfo('template_directory') . '/inc/plugins/exquisite-wp-plugin.zip', // The plugin source
