	...
	class Readable_Author_Widget extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				...
				_x( 'ProteusThemes: Author Widget', 'backend' , 'readable_wp'), // Name
				array(
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'selected_user_id' ); ?>"><?php _ex( 'Display author: ', 'backend', 'readable_wp'); ?></label>
