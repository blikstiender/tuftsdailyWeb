...
<head>
<title></title>
<link rel="stylesheet" href="<?php echo plugin_dir_url( __FILE__ ); ?>css/tinymce.css" />
<link rel="stylesheet" href="<?php echo plugin_dir_url( __FILE__ ); ?>css/chosen/chosen.css" />
<script src="<?php echo plugin_dir_url( __FILE__ ); ?>js/chosen/chosen.jquery.min.js"></script>
